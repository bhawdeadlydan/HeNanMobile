    ...
    private static class getLocationListByItemErpCode_resultStandardScheme extends StandardScheme<getLocationListByItemErpCode_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<rfid.service.LocationInfo>(_list56.size);
                  rfid.service.LocationInfo _elem57;
                  for (int _i58 = 0; _i58 < _list56.size; ++_i58)
                  {
                    _elem57 = new rfid.service.LocationInfo();
                    _elem57.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getLocationListByItemErpCode_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (rfid.service.LocationInfo _iter59 : struct.success)
            {
              _iter59.write(oprot);
            }
            oprot.writeListEnd();
    ...
    private static class getLocationListByItemErpCode_resultTupleScheme extends TupleScheme<getLocationListByItemErpCode_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getLocationListByItemErpCode_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (rfid.service.LocationInfo _iter60 : struct.success)
            {
              _iter60.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<rfid.service.LocationInfo>(_list61.size);
            rfid.service.LocationInfo _elem62;
            for (int _i63 = 0; _i63 < _list61.size; ++_i63)
            {
              _elem62 = new rfid.service.LocationInfo();
              _elem62.read(iprot);
    ...
    private static class getGoodsByLocation_resultStandardScheme extends StandardScheme<getGoodsByLocation_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<rfid.service.Good>(_list64.size);
                  rfid.service.Good _elem65;
                  for (int _i66 = 0; _i66 < _list64.size; ++_i66)
                  {
                    _elem65 = new rfid.service.Good();
                    _elem65.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getGoodsByLocation_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (rfid.service.Good _iter67 : struct.success)
            {
              _iter67.write(oprot);
            }
            oprot.writeListEnd();
    ...
    private static class getGoodsByLocation_resultTupleScheme extends TupleScheme<getGoodsByLocation_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getGoodsByLocation_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (rfid.service.Good _iter68 : struct.success)
            {
              _iter68.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<rfid.service.Good>(_list69.size);
            rfid.service.Good _elem70;
            for (int _i71 = 0; _i71 < _list69.size; ++_i71)
            {
              _elem70 = new rfid.service.Good();
              _elem70.read(iprot);
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.checks = new ArrayList<rfid.service.check>(_list72.size);
                  rfid.service.check _elem73;
                  for (int _i74 = 0; _i74 < _list72.size; ++_i74)
                  {
                    _elem73 = new rfid.service.check();
                    _elem73.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, confirmInventory_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.checks != null) {
          oprot.writeFieldBegin(CHECKS_FIELD_DESC);
          {
            ...
            for (rfid.service.check _iter75 : struct.checks)
            {
              _iter75.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetChecks()) {
          {
            ...
            for (rfid.service.check _iter76 : struct.checks)
            {
              _iter76.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.checks = new ArrayList<rfid.service.check>(_list77.size);
            rfid.service.check _elem78;
            for (int _i79 = 0; _i79 < _list77.size; ++_i79)
            {
              _elem78 = new rfid.service.check();
              _elem78.read(iprot);
