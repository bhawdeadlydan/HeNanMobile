    ...
    private static class confirmRetrieval_argsStandardScheme extends StandardScheme<confirmRetrieval_args> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.CNums = new ArrayList<String>(_list48.size);
                  String _elem49;
                  for (int _i50 = 0; _i50 < _list48.size; ++_i50)
                  {
                    _elem49 = iprot.readString();
                    struct.CNums.add(_elem49);
                  }
                  iprot.readListEnd();
                }
                struct.setCNumsIsSet(true);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, confirmRetrieval_args struct) throws TException {
        ...
        if (struct.CNums != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, struct.CNums.size()));
            for (String _iter51 : struct.CNums)
            {
    ...
    private static class confirmRetrieval_argsTupleScheme extends TupleScheme<confirmRetrieval_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, confirmRetrieval_args struct) throws TException {
        ...
        if (struct.isSetCNums()) {
          {
            oprot.writeI32(struct.CNums.size());
            for (String _iter52 : struct.CNums)
            {
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.CNums = new ArrayList<String>(_list53.size);
            String _elem54;
            for (int _i55 = 0; _i55 < _list53.size; ++_i55)
            {
              _elem54 = iprot.readString();
              struct.CNums.add(_elem54);
            }
          }
          struct.setCNumsIsSet(true);
        }
    ...
    private static class getLocationListByItemErpCode_resultStandardScheme extends StandardScheme<getLocationListByItemErpCode_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<LocationInfo>(_list56.size);
                  LocationInfo _elem57;
                  for (int _i58 = 0; _i58 < _list56.size; ++_i58)
                  {
                    _elem57 = new LocationInfo();
                    _elem57.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getLocationListByItemErpCode_result struct) throws TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (LocationInfo _iter59 : struct.success)
            {
              _iter59.write(oprot);
            }
            oprot.writeListEnd();
    ...
    private static class getLocationListByItemErpCode_resultTupleScheme extends TupleScheme<getLocationListByItemErpCode_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getLocationListByItemErpCode_result struct) throws TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (LocationInfo _iter60 : struct.success)
            {
              _iter60.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<LocationInfo>(_list61.size);
            LocationInfo _elem62;
            for (int _i63 = 0; _i63 < _list61.size; ++_i63)
            {
              _elem62 = new LocationInfo();
              _elem62.read(iprot);
    ...
    private static class getGoodsByLocation_resultStandardScheme extends StandardScheme<getGoodsByLocation_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<Good>(_list64.size);
                  Good _elem65;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getGoodsByLocation_result struct) throws TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (Good _iter67 : struct.success)
            {
              _iter67.write(oprot);
            }
            oprot.writeListEnd();
    ...
    private static class getGoodsByLocation_resultTupleScheme extends TupleScheme<getGoodsByLocation_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getGoodsByLocation_result struct) throws TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (Good _iter68 : struct.success)
            {
              _iter68.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<Good>(_list69.size);
            Good _elem70;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.checks = new ArrayList<check>(_list72.size);
                  check _elem73;
                  for (int _i74 = 0; _i74 < _list72.size; ++_i74)
                  {
                    _elem73 = new check();
                    _elem73.read(iprot);
                    struct.checks.add(_elem73);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, confirmInventory_args struct) throws TException {
        ...
        if (struct.checks != null) {
          oprot.writeFieldBegin(CHECKS_FIELD_DESC);
          {
            ...
            for (check _iter75 : struct.checks)
            {
              _iter75.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetChecks()) {
          {
            ...
            for (check _iter76 : struct.checks)
            {
              _iter76.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.checks = new ArrayList<check>(_list77.size);
            check _elem78;
            for (int _i79 = 0; _i79 < _list77.size; ++_i79)
            {
              _elem78 = new check();
              _elem78.read(iprot);
              struct.checks.add(_elem78);
            }
          }
          struct.setChecksIsSet(true);
        }
