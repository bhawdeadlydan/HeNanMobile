...
public class SB_WMS_WMS_ImportComEpuSimMatStorSrvInputItem  implements java.io.Serializable {
    ...
    private PutOut.BOMS_Item[] BOMS_Collection;

    private PutOut.WMS_DETAIL_Item[][][] WMS_DETAILS_Collection;
    ...
    public SB_WMS_WMS_ImportComEpuSimMatStorSrvInputItem(
           ...
           PutOut.BOMS_Item[] BOMS_Collection,
           PutOut.WMS_DETAIL_Item[][][] WMS_DETAILS_Collection) {
     ...
     */
    public PutOut.BOMS_Item[] getBOMS_Collection() {
        return BOMS_Collection;
    }
     ...
     */
    public void setBOMS_Collection(PutOut.BOMS_Item[] BOMS_Collection) {
        this.BOMS_Collection = BOMS_Collection;
    }
     ...
     */
    public PutOut.WMS_DETAIL_Item[][][] getWMS_DETAILS_Collection() {
        return WMS_DETAILS_Collection;
    }
     ...
     */
    public void setWMS_DETAILS_Collection(PutOut.WMS_DETAIL_Item[][][] WMS_DETAILS_Collection) {
        this.WMS_DETAILS_Collection = WMS_DETAILS_Collection;
    }
