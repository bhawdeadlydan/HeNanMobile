...
public class SB_WMS_WMS_ImportComEpuSimMatStorSrvBindingStub extends org.apache.axis.client.Stub implements PutOut.SB_WMS_WMS_ImportComEpuSimMatStorSrv_PortType {
    ...
    private static void _initOperationDesc1(){
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://mss.cmcc.com/SB_WMS_WMS_ImportComEpuSimMatStorSrv", "SB_WMS_WMS_ImportComEpuSimMatStorSrvRequest"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://mss.cmcc.com/SB_WMS_WMS_ImportComEpuSimMatStorSrv", "SB_WMS_WMS_ImportComEpuSimMatStorSrvRequest"), PutOut.SB_WMS_WMS_ImportComEpuSimMatStorSrvRequest.class, false, false);
        ...
        oper.setReturnClass(PutOut.SB_WMS_WMS_ImportComEpuSimMatStorSrvResponse.class);
    ...
    public SB_WMS_WMS_ImportComEpuSimMatStorSrvBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.1");
            ...
            cachedSerQNames.add(qName);
            cls = PutOut.PACKING_BOMS_Item[].class;
            cachedSerClasses.add(cls);
            ...
            cachedSerQNames.add(qName);
            cls = PutOut.PACKINGS_Item[].class;
            cachedSerClasses.add(cls);
            ...
            cachedSerQNames.add(qName);
            cls = PutOut.SALE_BOM_DETAIL_Item.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = PutOut.SALE_BOMS_Item[].class;
            cachedSerClasses.add(cls);
            ...
            cachedSerQNames.add(qName);
            cls = PutOut.SB_WMS_WMS_ImportComEpuSimMatStorSrvInputItem[].class;
            cachedSerClasses.add(cls);
            ...
            cachedSerQNames.add(qName);
            cls = PutOut.SB_WMS_WMS_ImportComEpuSimMatStorSrvRequest.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = PutOut.SB_WMS_WMS_ImportComEpuSimMatStorSrvResponse.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = PutOut.WMS_DETAIL_Item[].class;
            cachedSerClasses.add(cls);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {payload});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (PutOut.SB_WMS_WMS_ImportComEpuSimMatStorSrvResponse) _resp;
            } catch (java.lang.Exception _exception) {
                return (PutOut.SB_WMS_WMS_ImportComEpuSimMatStorSrvResponse) org.apache.axis.utils.JavaUtils.convert(_resp, PutOut.SB_WMS_WMS_ImportComEpuSimMatStorSrvResponse.class);
            }
        }
