...
public class BOMS_Item  implements java.io.Serializable {
    private PutOut.SALE_BOMS_Item[] SALE_BOMS_Collection;

    private PutOut.PACKING_BOMS_Item[] PACKING_BOMS_Collection;

    public BOMS_Item() {
    }

    public BOMS_Item(
           PutOut.SALE_BOMS_Item[] SALE_BOMS_Collection,
           PutOut.PACKING_BOMS_Item[] PACKING_BOMS_Collection) {
     ...
     */
    public PutOut.SALE_BOMS_Item[] getSALE_BOMS_Collection() {
        return SALE_BOMS_Collection;
    }
     ...
     */
    public void setSALE_BOMS_Collection(PutOut.SALE_BOMS_Item[] SALE_BOMS_Collection) {
        this.SALE_BOMS_Collection = SALE_BOMS_Collection;
    }
     ...
     */
    public PutOut.PACKING_BOMS_Item[] getPACKING_BOMS_Collection() {
        return PACKING_BOMS_Collection;
    }
     ...
     */
    public void setPACKING_BOMS_Collection(PutOut.PACKING_BOMS_Item[] PACKING_BOMS_Collection) {
        this.PACKING_BOMS_Collection = PACKING_BOMS_Collection;
    }
