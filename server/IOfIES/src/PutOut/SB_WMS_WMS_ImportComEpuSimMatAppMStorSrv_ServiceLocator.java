...
public class SB_WMS_WMS_ImportComEpuSimMatAppMStorSrv_ServiceLocator extends org.apache.axis.client.Service implements PutOut.SB_WMS_WMS_ImportComEpuSimMatAppMStorSrv_Service {
    ...
    public PutOut.SB_WMS_WMS_ImportComEpuSimMatAppMStorSrv_PortType getSB_WMS_WMS_ImportComEpuSimMatAppMStorSrvPort() throws javax.xml.rpc.ServiceException {
    ...
    public PutOut.SB_WMS_WMS_ImportComEpuSimMatAppMStorSrv_PortType getSB_WMS_WMS_ImportComEpuSimMatAppMStorSrvPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            PutOut.SB_WMS_WMS_ImportComEpuSimMatAppMStorSrvBindingStub _stub = new PutOut.SB_WMS_WMS_ImportComEpuSimMatAppMStorSrvBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (PutOut.SB_WMS_WMS_ImportComEpuSimMatAppMStorSrv_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                PutOut.SB_WMS_WMS_ImportComEpuSimMatAppMStorSrvBindingStub _stub = new PutOut.SB_WMS_WMS_ImportComEpuSimMatAppMStorSrvBindingStub(new java.net.URL(SB_WMS_WMS_ImportComEpuSimMatAppMStorSrvPort_address), this);
                _stub.setPortName(getSB_WMS_WMS_ImportComEpuSimMatAppMStorSrvPortWSDDServiceName());
                return _stub;
            }
        }
