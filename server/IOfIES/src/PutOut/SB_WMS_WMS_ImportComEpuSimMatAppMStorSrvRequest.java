...
public class SB_WMS_WMS_ImportComEpuSimMatAppMStorSrvRequest  implements java.io.Serializable {
    private PutOut.MsgHeader msgHeader;

    private PutOut.SB_WMS_WMS_ImportComEpuSimMatAppMStorSrvInputItem[] SB_WMS_WMS_ImportComEpuSimMatAppMStorSrvInputCollection;

    public SB_WMS_WMS_ImportComEpuSimMatAppMStorSrvRequest() {
    }

    public SB_WMS_WMS_ImportComEpuSimMatAppMStorSrvRequest(
           PutOut.MsgHeader msgHeader,
           PutOut.SB_WMS_WMS_ImportComEpuSimMatAppMStorSrvInputItem[] SB_WMS_WMS_ImportComEpuSimMatAppMStorSrvInputCollection) {
     ...
     * @return msgHeader
     */
    public PutOut.MsgHeader getMsgHeader() {
        return msgHeader;
    }
     ...
     * @param msgHeader
     */
    public void setMsgHeader(PutOut.MsgHeader msgHeader) {
        this.msgHeader = msgHeader;
    }
     ...
     */
    public PutOut.SB_WMS_WMS_ImportComEpuSimMatAppMStorSrvInputItem[] getSB_WMS_WMS_ImportComEpuSimMatAppMStorSrvInputCollection() {
        return SB_WMS_WMS_ImportComEpuSimMatAppMStorSrvInputCollection;
    }
     ...
     */
    public void setSB_WMS_WMS_ImportComEpuSimMatAppMStorSrvInputCollection(PutOut.SB_WMS_WMS_ImportComEpuSimMatAppMStorSrvInputItem[] SB_WMS_WMS_ImportComEpuSimMatAppMStorSrvInputCollection) {
        this.SB_WMS_WMS_ImportComEpuSimMatAppMStorSrvInputCollection = SB_WMS_WMS_ImportComEpuSimMatAppMStorSrvInputCollection;
    }
