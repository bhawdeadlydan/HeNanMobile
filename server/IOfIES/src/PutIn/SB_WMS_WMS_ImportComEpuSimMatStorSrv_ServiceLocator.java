...
public class SB_WMS_WMS_ImportComEpuSimMatStorSrv_ServiceLocator extends org.apache.axis.client.Service implements PutIn.SB_WMS_WMS_ImportComEpuSimMatStorSrv_Service {
    ...
    public PutIn.SB_WMS_WMS_ImportComEpuSimMatStorSrv_PortType getSB_WMS_WMS_ImportComEpuSimMatStorSrvPort() throws javax.xml.rpc.ServiceException {
    ...
    public PutIn.SB_WMS_WMS_ImportComEpuSimMatStorSrv_PortType getSB_WMS_WMS_ImportComEpuSimMatStorSrvPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            PutIn.SB_WMS_WMS_ImportComEpuSimMatStorSrvBindingStub _stub = new PutIn.SB_WMS_WMS_ImportComEpuSimMatStorSrvBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (PutIn.SB_WMS_WMS_ImportComEpuSimMatStorSrv_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                PutIn.SB_WMS_WMS_ImportComEpuSimMatStorSrvBindingStub _stub = new PutIn.SB_WMS_WMS_ImportComEpuSimMatStorSrvBindingStub(new java.net.URL(SB_WMS_WMS_ImportComEpuSimMatStorSrvPort_address), this);
                _stub.setPortName(getSB_WMS_WMS_ImportComEpuSimMatStorSrvPortWSDDServiceName());
                return _stub;
            }
        }
