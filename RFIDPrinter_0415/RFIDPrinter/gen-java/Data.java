            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.batchGoods = new ArrayList<List<Item>>(_list0.size);
                List<Item> _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  {
                    org.apache.thrift.protocol.TList _list3 = iprot.readListBegin();
                    _elem1 = new ArrayList<Item>(_list3.size);
                    Item _elem4;
      ...
      if (struct.isSetBatchGoods()) {
        {
          ...
          for (List<Item> _iter8 : struct.batchGoods)
          {
            {
              oprot.writeI32(_iter8.size());
              for (Item _iter9 : _iter8)
              {
                _iter9.write(oprot);
              }
            }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.batchGoods = new ArrayList<List<Item>>(_list10.size);
          List<Item> _elem11;
          for (int _i12 = 0; _i12 < _list10.size; ++_i12)
          {
            {
              org.apache.thrift.protocol.TList _list13 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
              _elem11 = new ArrayList<Item>(_list13.size);
              Item _elem14;
